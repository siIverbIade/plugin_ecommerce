...
class Json
{
    ...
    public function process() // lê processa o arquivo
    {
        ...
        $this->schemaJSON = json_decode($this->schemaJSONstring, true); // decodifica a string jason do esquema lido acima num M.D.A (Array Multi-Dimensional, devido ao parametro 'true')
    }
